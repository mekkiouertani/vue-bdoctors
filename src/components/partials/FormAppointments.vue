                ...
                <div class="row">
                    <div class="col-12 form-group mt-2">
                        <input type="text" class="form-control" name="title" id="title"
                            placeholder="Titolo della tua richiesta*" required>
                    </div>
                </div>
                <!-- RICHIESTA -->
                <div class="row">
                    <div class="col-12">
                        <div class="form-group mt-2">
                            <textarea class="form-control" name="message" rows="5" placeholder="Messagio (Opzionale)"
                                required min:5></textarea>
                        </div>
                    </div>
                    <div class="validate"></div>
                </div>
